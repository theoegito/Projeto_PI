...
void Assets_Load(Assets *a){
    ...
    a->texEnredo          = LoadTexture("assets/images/enredo.png");
    ...
    SetTextureFilter(a->texExplosion,  TEXTURE_FILTER_POINT);
    SetTextureFilter(a->texEnredo,     TEXTURE_FILTER_POINT);
    ...
    a->texBossBullet      = LoadTexture("assets/images/boss_bullet.png");
    ...
    a->texExplosion       = LoadTexture("assets/images/explosion.png");
    ...
    a->sExplosion    = LoadSound("assets/sounds/machinedeath_hq.wav");
...
void Assets_Unload(Assets *a){
    ...
    UnloadTexture(a->texExplosion);
    UnloadTexture(a->texEnredo);
